...
export const clusteredPointCfg = {
  ...
  paint: {
    ...
    'circle-color': [
      ...
      100,
      '#f1f075', // Колір для кластерів >= 100 точок
      750,
      '#f28cb1', // Колір для кластерів >= 750 точок
    ],
    'circle-radius': [
      'step',
      ['get', 'point_count'],
      ...
      100,
      30, // Радіус 30px для >= 100 точок
      750,
      40, // Радіус 40px для >= 750 точок
    ],
  },
};
